...
class AppFixtures extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        $sweatshirts = [
            ...
            ['name' => 'BlueBelt', 'price' => 29.90, 'isFeatured' => false, 'image' => 'bluebelt.jepg'],
            ['name' => 'Street', 'price' => 34.50, 'isFeatured' => false, 'image' => 'street.jepg'],
            ['name' => 'Pokeball', 'price' => 45.00, 'isFeatured' => true, 'image' => 'pokeball.jpeg'],
            ['name' => 'PinkLady', 'price' => 29.90, 'isFeatured' => false, 'image' => 'pinklady.jeg'],
